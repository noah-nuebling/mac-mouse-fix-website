...
export default defineNitroPlugin((nitroApp) => {
  ...
  // Plug into nuxt-simple-sitemap, and remove the github subdomain. Otherwise the sitemap will generate urls like macmousefix.com/mac-mouse-fix-website-nuxt/about instead of macmousefix.com/about (where mac-mouse-fix-website-nuxt is the github pages subdoimain)
