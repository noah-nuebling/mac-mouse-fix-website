...
<template>
  ...
  @click="openLink">
    ...
    <!-- Quote Source -->
    <div v-if="quote" class="flex justify-center mt-[-2.05em] mb-[0.6em] mx-[1.5em] strong:font-[600] safari:strong:safari-text-glow-2 strong:text-glow-2 strong:inline-block strong:text-white/[0.3] text-white/[0.5] font-[400]">
