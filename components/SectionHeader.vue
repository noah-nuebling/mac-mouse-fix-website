<template>
  <div class="w-full flex flex-col justify-center items-center">
    ...
    <div class="section-body mx-[1.5rem] flex justify-center items-center my-[25vh]">
      <p v-if="body" v-html="body" class="fadeee text-center max-w-[30em] whitespace-pre-wrap sm:text-[1.4rem] text-[2rem] text-black/[0.9] font-[400] strong:font-[500] leading-[1.4] tracking-[-0.005rem]"></p>
    </div>
  </div>
</template>
