  ...
  <FeatureCard 
    ...
    <template v-slot:default>
      ...
      <div class="backdrop-blur-xl rounded-[0px] border-t-[4px] mt-5 border-gray-50/25 min-h-[52px] flex items-center justify-center cursor-pointer group-hover:underline">
        ...
        <a class="text-lg dark-bg text-white/90 text-center shadow-black/100"><span class=""> See How To Use Keyboard Shortcuts From Your Mouse</span><span class="inline-space-[8]"/><img src="~/assets/img/play.circle-dark@2x.png" alt="Play Video Icon" class="ml-[0px] inline h-[1.16rem] align-[-3.6px] filter brightness-0 invert drop-shadow-xl"></a>
      </div>
    </template>
