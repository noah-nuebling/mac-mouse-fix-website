    ...
    <div class="flex items-center justify-center group w-[100%] h-[100svh] relative z-[-20]">
      ...
      <div class="h-fit w-fit relative translate-y-[-1.5rem]">
        <div ref="innerContent" :class="['h-fit w-fit relative flex flex-col items-center justify-center -z-20', 
          ...
          <!-- TODO: The introTagline *has* to be narrower than the mmfName, to not get cut off. But if we make it wrap (Necessary in Turkish [Dec 2025], the math for the zoom animation goes wrong. [Dec 2025] -->
          <p ref="introTagline" :style="{ fontOpticalSizing: 'none'}" :class="['xs:tracking-[0.03em] tracking-[0.05em] whitespace-nowrap w-fit text-center fontxxx-[Helvetica] xs:text-[1.0rem] text-[1.1rem] text-black mb-[2.25rem] opacity-1']">{{ mdrf(MFLocalizedString(`Make Your $10 Mouse Better Than an Apple Trackpad!`, 'intro.tagline', `If this text appears wider than the big 'Mac Mouse Fix' text right above, it will get clipped at certain window sizes. I think you can only figure this out while actually looking at the live website... So you should perhaps come back to this after your initial translations have been added to the live website... Or just leave it. I should make the layout code work with any text length. [Dec 2025]`)) }}</p>
