...
The main way to access Localizable.js is through the vuei18n framework. E.g. it lets you access translations with $t() (Update: Use MFLocalizedString() instead) or lets you access a list of locales with $i18n.locales.
