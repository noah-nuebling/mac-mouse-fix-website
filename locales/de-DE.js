export default {
  ...
  'trackpad-features.header': '**Trackpad-Gesten** welche Mac Mouse Fix auf deine Maus bringt*',
  ...
  'feature.free-scroll.title': 'Präzises 360\xB0-Scrollen',
  ...
  // 'scrolling.body': "Mit Mac Mouse Fix fühlt sich das Scrollen auf deiner Maus so **geschmeidig** und **flüssig** an wie auf einem Apple Trackpad oder so **konsistent** und **präzise** wie unter Windows.",

  // 'scroll-smoothness.header': 'Wähle deine **Scroll-Geschmeidigkeit**',

  // 'scroll-smoothness.high.title': 'Geschmeidigkeit: **Hoch**',
  // 'scroll-smoothness.high.body': "Die Option 'Hoch' in Mac Mouse Fix emuliert präzise **das flüssige Scrollen eines Trackpads**, einschließlich Details wie das subtile Springen am Ende einer Seite. Du kannst auch weite Strecken leicht scrollen, und das Scrollen bleibt sehr präzise und reaktionsschnell.",
  // 'scroll-smoothness.regular.title': 'Geschmeidigkeit: **Normal**',
  // 'scroll-smoothness.regular.body': "Wähle die normale Geschmeidigkeit für **schnelleres Scrollen**, das weniger geschmeidig ist als auf einem Trackpad, aber dennoch ein großartiges, raffiniertes Gefühl mit physikbasierten Animationen bietet.\n\nEs fühlt sich ähnlich wie das Scrollen in Chrome oder modernen Windows-Anwendungen an, nur etwas angenehmer.",
  // 'scroll-smoothness.off.title': 'Geschmeidigkeit: **Aus**',
  // 'scroll-smoothness.off.body': "Mit dieser Option funktioniert das Scrollen wie gewohnt unter macOS - ohne jede Animation oder Glättung. Aber mit einem entscheidenden Unterschied: In Apps wie Finder wird **eine Raste des Scrollrads eine festgelegte Anzahl von *Zeilen* scrollen**, anstatt nur ein paar Pixel, was die Navigation konstanter und angenehmer macht.\n\nSo funktioniert das Scrollen in Windows und Linux sowie in älteren macOS-Versionen.",
  ...
  'quotes.1': "Mac Mouse Fix ist buchstäblich alles, was man sich für die Nutzung einer Maus mit OSX wünschen könnte. xxx",
  ...
  'quotes.4': "Vielen Dank für die fantastische App Mac Mouse Fix. Genau das, was ich gebraucht habe, ohne Abonnement und ohne unnötigen Ballast. Vielen, vielen Dank! xxx",
  'quotes.5': "Mac Mouse Fix ist magisch. Ich bin absolut hin und weg, wie gut gestaltet und benutzerfreundlich es ist. xxx",
  ...
  'quotes.8': "Wahrscheinlich die beste App auf meinem Mac. xxx",
  'quotes.9': "Keine andere ähnliche Software kann konkurrieren. xx",
  'quotes.10': "Eine Muss-App für jeden Mac-Benutzer mit einer Maus. xxx",
  'quotes.11': "Du hast mich gerade davor bewahrt, Geld für die MX Master auszugeben. xxx",
  'quotes.12': "Das hat meine Produktivität fast verdoppelt. xxx",
  'quotes.13': "Die Benutzeroberfläche und die Gesten sind so intuitiv. xxx",
  'quotes.14': "Ich liebe diese App so sehr, sie ist ein Muss! xxx",
  'quotes.15': "Deine App ist unglaublich und absolut unverzichtbar für meinen Arbeitsablauf. Ich kann meinen Mac buchstäblich nicht ohne MMF benutzen. xxx",
  'quotes.16': "Mac Mouse Fix ist für mich die wichtigste Mac-App. Sie fühlt sich unglaublich poliert an. xxx",
  'quotes.17': "Mac Mouse Fix ist das Beste seiner Klasse!",
  'quotes.18': "Das vertikale Scrollen ist einfach genial. xxx",
  'quotes.19': "Klicken & Ziehen zum Wechseln zwischen den Bildschirmen fühlt sich so natürlich an.",
  'quotes.20': "Ich wollte schon seit einer Weile meine Magic Mouse loswerden und dank deiner App kann ich das jetzt auch! xxx",
  'quotes.21': "Ich empfehle Mac Mouse Fix, ehrlich gesagt ist es die preisgünstigste, einfachste und am besten programmierte App, die ich bis jetzt gesehen habe. xxx",
  'quotes.22': "Danke, du hast mich davor bewahrt, eine Apple-Maus zu kaufen xxx",
  'quotes.23': "Die Benutzeroberfläche in V2 ist fantastisch und sehr intuitiv. xxx",
  'quotes.24': "Ich habe letzte Woche ohne die App verbracht und mein ganzer Arbeitsablauf war unterbrochen. Vielen Dank für so eine brillante App. xxx",
  'quotes.25': "Ich schätze die Einfachheit, die die App mit sich bringt, wirklich.",
  'quotes.26': "Nachdem ich zu einer Maus gewechselt habe, habe ich Software wie SteerMouse ausprobiert, die viele Empfehlungen erhält und sogar kostenpflichtig ist, und letztendlich festgestellt, dass Mac Mouse Fix meine Bedürfnisse perfekt erfüllt, jedes Feature ist sehr nützlich und die Leistung ist sehr gut!",
  'quotes.27': "Tolle App, sie verdient es definitiv, weit verbreitet zu werden 😁 xxx",
  'quotes.28': "Diese App macht deine günstige Maus besser als Trackpad-Gesten",
  'quotes.29': "Dies ist die großartigste Software in der Geschichte von Apple. xxx",
  'quotes.30': "Dies ist großartige Software und hat alle meine Mausprobleme gelöst.",
  'quotes.31': "Unglaublich unglaubliche Software, Bruder :) so einfach und doch so funktional. Mach weiter so. xxx",
  'quotes.32': "Deine App ist buchstäblich der beste Mac-Maus-Fix, der verfügbar ist. So einfach, ressourcenschonend, M1-kompatibel, ohne Bugs. Ich bin total verliebt. Ich benutze nicht einmal mehr das Logitech Hub, weil deine App weit überlegen ist. Ich werde deine App definitiv so oft wie möglich weiterempfehlen. xxx",
  'quotes.33': "Es ist genau das, was ich gesucht habe, damit Nicht-Apple-Mäuse so funktionieren, wie ich es möchte xxx",
  'quotes.34': "Diese Software ist erstaunlich! xxx",
  'quotes.35': "Danke, die App ist sehr cool",
  'quotes.36': "SUPER SCHÖNE ANWENDUNG xxx",
  'quotes.37': "Es funktioniert perfekt mit meiner Maus",
  'quotes.38': "Funktioniert so gut! Großartige Idee und Umsetzung, und natürlich das Design, in bester Apple-Tradition! xxx",
  'quotes.39': "Vielen Dank für Mac Mouse Fix – es ist zu einem unverzichtbaren Werkzeug für mich geworden, und von allen Programmen dieser Art, die ich gefunden habe, ist es mit Abstand das Beste. xxx",
  ...
  'quotes.42': "Du bist eine absolute Legende, vielen Dank, dass du diese App kreiert hast, sie ist buchstäblich perfekt xxx",
  'quotes.43': "Danke für deine großartige App, sie ist einfach wunderbar :). xxx",
