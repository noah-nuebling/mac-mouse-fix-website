export default {
  ...
  'quotes.translation-disclaimer.de': "", // Leave out the current language
  ...
  'quotes.0': "Unter all den Apps, die versuchen, dieses Problem zu lösen, ist diese zweifellos die beste!",
  ...
  'quotes.12': "Das hat meine Produktivität fast verdoppelt.",
  'quotes.13': "Die Benutzeroberfläche und die Gesten sind so intuitiv.",
  'quotes.14': "Ich liebe diese App so sehr, sie ist ein Muss!",
  'quotes.15': "Deine App ist unglaublich und absolut unverzichtbar für meinen Arbeitsablauf. Ich kann meinen Mac buchstäblich nicht ohne MMF benutzen.",
  'quotes.16': "Mac Mouse Fix ist für mich die wichtigste Mac-App. Sie fühlt sich unglaublich poliert an.",
  'quotes.17': "Mac Mouse Fix ist die beste seiner Klasse!",
  ...
  'quotes.24': "Ich habe letzte Woche ohne sie verbracht und mein ganzer Arbeitsablauf war unterbrochen. Vielen Dank für so eine brillante App.",
  'quotes.25': "Ich schätze die Einfachheit, die sie mit sich bringt, wirklich.",
  'quotes.26': "Nachdem ich zu einer Maus gewechselt habe, habe ich Software wie SteerMouse ausprobiert, die viele Empfehlungen erhält und sogar kostenpflichtig ist, und letztendlich festgestellt, dass diese Software meine Bedürfnisse perfekt erfüllt, jedes Feature ist sehr nützlich und die Leistung ist sehr gut!",
  'quotes.27': "Tolle App, sie verdient es definitiv, weit verbreitet geteilt zu werden 😁",
  ...
  'quotes.32': "Deine App ist buchstäblich der beste Mac-Maus-Fix, der verfügbar ist. So einfach, leicht, M1-kompatibel, ohne Bugs. Ich bin total verliebt. Ich benutze nicht einmal mehr das Logitech Hub, weil deine App weit überlegen ist. Ich werde deine App definitiv so oft wie möglich weiterempfehlen.",
  ...
  'quotes.46': "Danke für dies, ich verstehe nicht, warum Apple das nicht zum Standard gemacht hat, es ist super intuitiv, Gesten mit dem Mittelklick zu machen.",
