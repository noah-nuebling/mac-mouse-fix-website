export default {
  ...
  */
  ...
  'remap-engine.body': "Mac Mouse Fix lets you **do almost anything** you can think of - straight from your mouse! And yet, it's **remarkably easy** to use.", //"**Powerful customization options** usually come with a complex user interface. Well, you guessed it, not with Mac Mouse Fix! It lets you set up your mouse exactly the way you want, while being **remarkably simple**.", //"Too often, powerful customization options come with **complex** and **confusing** user interfaces. Well, you guessed it, not Mac Mouse Fix! It lets you set up your mouse **exactly** the way you want - and it's **remarkably easy**!", //"Set up your mouse **exactly** how you want it - In **seconds**!", // "With Mac Mouse Fix you can configure your mouse to do **almost anything** your computer can do - in a vast number of ways. And it takes only **seconds** to set up.", // "With Mac Mouse Fix you can configure your mouse to do **almost anything** - in almost any way. And it takes **seconds** to set up.", //"With Mac Mouse Fix, you can set up your Mouse exactly how you want it - **in seconds**. [[details -- breeze through macOS ]]", //Customizing how your mouse works in Mac Mouse Fix is **better than in any competing app** - Both when it comes to how **easy** it is, *and* when it comes to the range of **powerful** things you can do. That's amazing isn't it? ||| Mac Mouse Fix makes it incredibly **easy and intuitive to precisely customize** what your mouse does.
  ...
  */
  ...
  'open-source.body': "The source code of Mac Mouse Fix is available on GitHub, so everyone can see exactly how it works. This helps with the development, and it means you can be sure that Mac Mouse Fix is **secure** and **trustworthy**, that it protects your **privacy**, and that it doesn't do anything when it runs in the background - except bringing your mouse experience to the next level!", //Also, other awesome projects can benefit from Mac Mouse Fix' innovations in trackpad simulation and other areas.",
