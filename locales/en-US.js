export default {
  ...
  */
  ...
  'alternatives.body': "Mac Mouse Fix makes your $10 mouse better than an Apple Trackpad. And **far** better than a Logitech MX Master! Even though those two are often considered the best input devices for Macs. \n\nYet, Mac Mouse Fix is **{ priceFactorMXMaster }x** cheaper than an MX Master and **{priceFactorTrackpad}x** cheaper than a Trackpad! How's that for a deal?!?!?!?!? 😎",  
  ...
  'price.disclaimer': "Note on taxes: The price of **${price}** does not include local taxes, which might have to be paid in your region. To see your total price, visit the <a href='https://noahnuebling.gumroad.com/l/mmfinappusd?wanted=true' target='_blank'>checkout page</a>. I would really like to include the tax in the price - to make the buying experience simpler and clearer. But this is currently not feasible due to limitations with the sales platform Gumroad.com. I hope the price still feels very fair and cheap.",
